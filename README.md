...
Price data construction & combining with other variables (exchange rate, VAX, VAM, ...): (you can skip this part because the price dataset is provided. )
...
The list of the data folder only shows 1,000 files, but there are over 1,000 files. 
